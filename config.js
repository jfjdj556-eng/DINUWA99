...
module.exports = {
    ...
    REJECT_MSG: process.env.REJECT_MSG || '*𝘾𝘼𝙇𝙇 𝙈𝙀 𝙇𝘼𝙏𝙀𝙍 | පස්සෙ  කොල් කරාම් ✌️*',
    
    // ===========================================================
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://files.catbox.moe/79y64g.png',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbDDm8cGU3BQyAP9ck3R',
