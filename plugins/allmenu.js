...
cmd({
    ...
    try {
        ...
        // ⏰ Time & Date
        const time = moment().tz("Srilanka/Colombo").format("hh:mm:ss A");
        const date = moment().tz("Srilanka/Colombo").format("dddd, DD MMMM YYYY");

        // 🎨 Build Menu
        let menu = `*╭═══ 𓆩𝐃𝐈𝐍𝐔𝐖𝐀 𝐌𝐃𓆪 ═══⊷*\n`;
        menu += `*┃❃╭──────────────*\n`;
        menu += `*┃❃│ ⏰ ᴛɪᴍᴇ: ${time}*\n`;
        menu += `*┃❃│ 📅 ᴅᴀᴛᴇ: ${date}*\n`;
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: "120363408395408335@newsletter",
                    newsletterName: "𓆩𝐃𝐈𝐍𝐔𝐖𝐀 𝐌𝐃𓆪",
                    serverMessageId: 2,
                },
            },
        }, { quoted: fakevCard });
